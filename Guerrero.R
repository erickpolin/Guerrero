...
attach(ConcGuerrero) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcGuerrero<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcGuerrero) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcGuerrero$factor,to.data.frame=TRUE)
...
ConcGuerrero$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcGuerrero$MAXT<-ConcGuerrero$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcGuerrero<-ConcGuerrero[with(ConcGuerrero, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcGuerrero$ACUMULA<-cumsum(ConcGuerrero$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcGuerrero[dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcGuerrero<-rbind(ConcGuerrero[1:(dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1]+1),],
                      ConcGuerrero[(dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1]+1):dim(ConcGuerrero[1])[1],])
  
  b1<-tam_dec*i-ConcGuerrero[dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcGuerrero[(dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcGuerrero[(dim(ConcGuerrero[ConcGuerrero$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcGuerrero$ACUMULA2<-cumsum(ConcGuerrero$factor)

#aqu? estamos creando una variable que se llama decil que solo tiene ceros
ConcGuerrero$DECIL<-0
...
ConcGuerrero[(ConcGuerrero$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcGuerrero[((ConcGuerrero$ACUMULA2>tam_dec*i)&(ConcGuerrero$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcGuerrero[ConcGuerrero$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Guerrero")
write.dbf(ConcGuerrero,file="ConcGuerrero2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Guerrero")
write.dbf(ConcGuerrero,file="ConcGuerrero2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Guerrero")
Conc2010<-read.dbf("ConcGuerrero2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Guerrero por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Guerrero INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Guerrero NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Guerrero")
Conc2018<-read.dbf("ConcGuerrero2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Guerrero Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Guerrero INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Guerrero NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Guerrero NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Guerrero NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Guerrero NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Guerrero NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Guerrero por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Guerrero Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Guerrero NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Guerrero NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Guerrero INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Guerrero INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
